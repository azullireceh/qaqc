								...
								<table id="datatable-column-interactive" class="table table-sorting table-hover table-bordered colored-header datatable">
									...
									<tbody>
										...
										<tr>
											...
											<td>{{$mrs->link}}</td>
											<td>{{$mrs->path_qr}}</td>
											<td><a href="{{ asset('storage/pnid/' . $mrs->path_pnid) }}" target="_blank">{{$mrs->path_pnid}}</td>
											<td><img src="{{ asset('storage/' . $mrs->path_qr) }}" alt="QR Code MRS" width="100"></td>
											<td><a href="/mrs/{{$mrs->id}}/viewmrs" class="btn btn-primary btn-sm">View</td>
											...
											<td><a href="/historymrs/{{$mrs->id}}/mrs" class="btn btn-primary btn-sm">History</td>
